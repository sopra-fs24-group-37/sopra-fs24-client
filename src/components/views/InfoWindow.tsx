...
const InfoWindow: React.FC<InfoWindowProps> = ({ onClose }) => (
  <div className="info-window">
    ...
    <p className="info-content">
      ...
      geography of Switzerland for up to four players. In each round, you will see a random image from
      somewhere in Switzerland. Your task is to guess where the image was taken
      by clicking on a map of Switzerland.
